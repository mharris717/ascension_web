...
EmberHandlebars.registerHelper('if', function(context, options) {
  ...
  Ember.assert("You must pass exactly one argument to the if helper, args are " + arguments[0] + " , " + arguments[1],arguments.length === 2);
    ...
    Router.prototype = {
      ...
      */
      paramsForHandler: function(handlerName, callback) {
        ...
        console.debug("paramsForHandler")
...
var Application = Ember.Application = Ember.Namespace.extend(Ember.DeferredMixin, {
  ...
  */
  advanceReadiness: function() {
    //old = this._readinessDeferrals;
    this._readinessDeferrals--;

    //console.debug("updated _readinessDeferrals from " + old + " to " + this._readinessDeferrals);
